...
and a configuration file, or in other words, to automatize the Textured Painted
Relief generation process. Expected user inputs are preprocessed raster or vector
